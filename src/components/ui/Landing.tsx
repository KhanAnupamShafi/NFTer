...
const Landing = () => {
  return (
    <div className="mx-auto max-w-[1440px] px-4 sm:px-6">
      <div className="flex flex-col-reverse items-center justify-between gap-[90px] lg:h-[calc(100vh-120px)] lg:flex-row">
        <div className="relative w-full max-w-[600px]">
          <h1 className="pb-5 font-serif text-2xl font-bold lg:text-4xl ">
          ...
          <div className="flex items-center gap-10 pt-12">
            <div>
              <h2 className="pb-1 font-serif text-2xl font-bold tracking-wide lg:text-4xl">
                98K+
              </h2>
        ...
        <div className="relative h-[240px]  w-[70%] text-white sm:h-[440px] md:w-[40%] lg:max-w-[400px]">
          <div className="absolute left-0 z-40 -translate-x-1/2 translate-y-1/2"></div>
          <Image className="h-92" fill alt="" src={'/images/unsplash-1.png'} />
          <div className="absolute left-1/2 top-5 flex w-full max-w-[340px] -translate-x-1/2 transform flex-col items-start justify-between gap-2 rounded-lg  p-4 backdrop-blur-md">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs font-bold sm:text-xl">Arkhan17</p>
            </div>
          </div>
          <div className="absolute bottom-5 left-1/2 flex w-full max-w-[340px] -translate-x-1/2 transform items-center justify-between rounded-lg bg-white bg-opacity-20 p-4 backdrop-blur-md">
            <div>
              ...
              <h4 className="flex items-center justify-center gap-2 text-xs font-bold sm:text-base">
                <span>
                  <svg
            ...
            <div>
              ...
              <h4 className="text-xs font-bold sm:text-base">12h 43m 42s</h4>
            </div>
          </div>
          <div className="absolute top-1/2 -translate-x-1/2 ">
            ...
            <div className="rounded-text rotating hidden rounded-full bg-[#FFE0D4] sm:block">
